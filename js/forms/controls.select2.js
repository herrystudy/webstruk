...
class Select2Controls {
    constructor() {
        ...
        this._initSelect1Basic();
        this._initSelect2Basic();
        this._initSelect3Basic();
    ...
    // Basic single select1
    _initSelect1Basic() {
        jQuery("#select1Basic").select2({ placeholder: "" });
    }
    ...
    // Basic single select3
    _initSelect3Basic() {
        jQuery("#select3Basic").select2({ placeholder: "" });
    }
